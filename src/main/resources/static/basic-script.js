...
var options = {
  //지도를 생성할 때 필요한 기본 옵션
  center: new kakao.maps.LatLng(35.141274248133, 129.10846432617), //지도의 중심좌표. 남천동
...
const dataSet = [
  {
    ...
    url: "https://www.youtube.com/watch?v=htAqRBppL4A",
    category: "한식",
  },
  {
    title: "동방명주",
    address: "부산 수영구 남천바다로 31",
    url: "https://www.youtube.com/watch?v=5lQ1Fbo_pvY&t=9s",
    category: "중식",
  },
  {
    title: "안동한우갈비",
    address: "부산 수영구 황령대로481번길 45",
    url: "https://www.youtube.com/watch?v=izz7CxIjuz0&t=45s",
    category: "구이",
  },
];
